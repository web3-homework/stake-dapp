...
const STAKING_ABI = [
    ...
    },
    {
        ...
        name: "getUserTotalClaimedRewards",
        outputs: [
            {
                internalType: "uint256",
                name: "",
...
export default function StakingDApp() {
    ...
    const {
        data: userTotalClaimedRewards,
        refetch: refetchUserTotalClaimedRewards,
        isFetching: isFetchingUserTotalClaimedRewards,
    } = useReadContract({
        address: STAKING_CONTRACT_ADDRESS,
        abi: STAKING_ABI,
        functionName: "getUserTotalClaimedRewards",
        args: [address!],
        query: { enabled: !!address },
    });
                            ...
                            <CardContent className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-blue-600 mt-1">
                                        {stakedAmount ? formatNumber(Number(formatEther(stakedAmount)), 4) : "0.0000"}{" "}
                                        ETH
                                    </p>
                                </div>
                                <Separator />
                                <div>
                                    <Label className="text-sm text-gray-600">累计领取奖励</Label>
                                    <div className="text-2xl font-bold text-green-600 mt-1 flex flex-col items-center">
                                        {userTotalClaimedRewards ? (
                                            <>
                                                <div className="mb-1">{userTotalClaimedRewards.toString()} wei</div>
                                                <div className="opacity-80 mb-1">≈</div>
                                                <div>
                                                    {formatNumber(Number(formatEther(userTotalClaimedRewards)), 6)} ETH
                                                </div>
                                            </>
                                        ) : (
                                            <>
                            ...
                            <CardContent className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-600 mt-1">
                                        {rewardRate ? `${Number(rewardRate) / 100}%` : "12%"}
                                    </p>
                                </div>
                                <Separator />
